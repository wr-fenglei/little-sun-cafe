...
const CACHE=CACHE_PREFIX+'c96abb2835d0';
const FILES=["./","./THIRD-PARTY-NOTICES.txt","./assets/index-B3FiY1J1.js","./assets/index-ClWw5FCD.css","./assets/mother-baby.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/icon.svg","./index.html","./manifest.webmanifest"];
