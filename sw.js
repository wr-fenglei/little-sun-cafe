...
const CACHE=CACHE_PREFIX+'85dd4e60cd45';
const FILES=["./","./THIRD-PARTY-NOTICES.txt","./assets/customer-moods.png","./assets/index-D58-js-h.js","./assets/index-DGLwdvUG.css","./assets/mother-baby.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/icon.svg","./index.html","./manifest.webmanifest"];
