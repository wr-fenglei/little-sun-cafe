...
const CACHE=CACHE_PREFIX+'189be772068d';
const FILES=["./","./THIRD-PARTY-NOTICES.txt","./assets/index-Clw0398C.js","./assets/index-tRPtAzTQ.css","./assets/mother-baby.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/icon.svg","./index.html","./manifest.webmanifest"];
