...
const CACHE=CACHE_PREFIX+'2d49542a6f55';
const FILES=["./","./THIRD-PARTY-NOTICES.txt","./assets/index-Dnf_4wbU.js","./assets/index-DsukQD6_.css","./assets/mother-baby.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/icon.svg","./index.html","./manifest.webmanifest"];
