...
const CACHE=CACHE_PREFIX+'c1b416002417';
const FILES=["./","./THIRD-PARTY-NOTICES.txt","./assets/index-BXM8I9Ok.js","./assets/index-DsukQD6_.css","./assets/mother-baby.png","./icons/apple-touch-icon.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png","./icons/icon.svg","./index.html","./manifest.webmanifest"];
